...
---
### 0009. 代码(HTML中所谓的Code)
**[001. 实现方式有两种:]{s}**
  - [001. 第一种：简单文字出现一个代码框。使用`<blockquote>`。(`不是单引号而是左上角的ESC下面~中的`)]{g}
  - [002. 第二种：大片文字需要实现代码框。使用Tab和四个空格。]{g}
