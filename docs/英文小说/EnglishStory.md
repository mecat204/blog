...
---
* **小说（英文表达）**
  - novel | 长篇小说（最常用、最标准的说法）

---
* **相关常见表达**
  - fiction | 小说 / 虚构文学（统称概念）
  - story | 故事（不特指小说，范围更广）
...
* **按类型区分**
  - romance novel | 言情小说
  - science fiction (sci-fi) novel | 科幻小说
  - fantasy novel | 奇幻小说
  - historical novel | 历史小说
  - detective / mystery novel | 推理小说
  - web novel / online novel | 网络小说

---
* **示例句**
  - I’m reading a novel. | 我正在看一本小说
  - This is a Chinese web novel. | 这是一本中国网络小说
