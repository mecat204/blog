...
* **[haitang](https://github.com/javayhu/haitang)**
  ...
  ``` bash
  $ npx astro dev --host 192.168.1.3 --port 4321
  $ npx astro dev --host
  04:25:46 [types] Generated 11ms

  astro  v4.16.19 ready in 16095 ms
  ┃ Local    http://localhost:4321/
  ┃ Network  http://192.168.1.3:4321/
           http://192.168.127.1:4321/
           http://192.168.204.1:4321/
           http://172.29.192.1:4321/
