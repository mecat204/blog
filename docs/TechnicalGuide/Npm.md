...
---
**[003. 删除 node_modules 和 package-lock.json 后重试]{s}**
``` bash
...
---
**[008. 使用 --depth=1 做浅克隆（只克隆最近一次提交）]{s}**
``` bash
...
**[npm / cnpm / yarn / pnpm 本身都是“包管理工具”]{s}**
