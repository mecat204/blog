...
---
**[Dpanel]{s}**
* **[Dpanel | 轻量化容器管理面板](https://dpanel.cc/#/)**

---
**[TuringPlanet]{s}**
* **[TuringPlanet – 编程和AI爱好者的栖息地](https://turingplanet.org/)**
...
### 0001. X share
**[morphicons]{s}**
* **[guillermolg00](https://github.com/guillermolg00/morphicons)**
  - [morphicons — SVG icon morphing library for React, Vue &amp; Svelte](https://www.morphicons.com/)

---
**[Echo-Loop]{s}**
* **[Echo-Loop](https://github.com/echo-loop/Echo-Loop)**
  - [Echo Loop — Build Your Listen-to-Speak Training Loop | Echo Loop](https://www.echo-loop.top/)
  - [需要Mail登录]{g}

---
**[Disney]{s}**
* **[Disney Movies | The Official Disney Films from Disney | Disney Singapore](https://www.disney.sg/movies)**
  - [Hoppers](https://www.disney.sg/movies/hoppers)
  - [cineplay](https://www.cineplay.to/)
  - [subtitlecat](https://www.subtitlecat.com/)

---
**[walkinglabs.learn-harness-engineering]{s}**
* **[learn-harness-engineering](https://github.com/walkinglabs/learn-harness-engineering)**
  - [walkinglabs.learn-harness-engineering](https://walkinglabs.github.io/learn-harness-engineering/zh/)

---
**[Csaba Kissi ·yosaiy·github]{s}**
* **[yosaiy·renotch](https://github.com/yosaiy/renotch)**
  - **[Kitbitz — 2,000+ free hand-drawn illustrations 插图](https://kitbitz.art/)**
  - [Open-source Liquid effects for React UI](https://gooey.jakubantalik.com/)
  - [Free motion design for Mac](https://openmotion.design/)
  - [UI prompt library for vibe coders with 251 elements](https://vibeprompts.dev/)

---
**[Alex Tatu]{s}**
* **[React Component Registry: Components, Blocks &amp; Design Systems | AI Canvas](https://aicanvas.me/)**
...
---
**[Bakai.]{s}**
* **[Bakai.](https://www.bakai.me/)**
  - [QR reveal animation QR 显示动动画](https://www.bakai.me/lab)

---
**[vincentwei]{s}**
* **[镜头配方与动态样片 | video-shotcraft](https://vincentwei1021.github.io/video-shotcraft/library.html)**

---
**[Viktor Oddy]{s}**
* **[olympusdao](https://olympusdao.finance/?ref=land-book.com)**

---
**[img2threejs]{s}**
* **[img2threejs](https://github.com/img2threejs/img2threejs)**
  - [threejs](https://img2threejs.github.io/img2threejs-showcase/#/x/bmx-endurance)

---
**[全球 Maker 发现｜造物矩阵]{s}**
* **[造物矩阵](https://zaowujuzhen.com/)**
  - [发现全球 Maker](https://zaowujuzhen.com/bip/makers)

---
**[huggingface.co]{s}**
* **[LongCat-Video-Avatar-1.5](https://huggingface.co/spaces/victor/LongCat-Video-Avatar-1.5)**

---
**[alexei]{s}**
* **[Neuroplasticity: How Repetition Quietly Decides Who You Become | 神经可塑性：重复如何悄然决定你成为怎样的人](https://x.com/alexeixbt/article/2086051211271196886)**

---
**[HKUDS | Data Intelligence Lab @ HKU | 香港大学数据智能实验室]{s}**
* **[DeepTutor](https://github.com/HKUDS/DeepTutor)**
  - [DeepTutor — Agent-native, open-source personalized tutoring](https://deeptutor.info/)
  - [完整安装指南](https://docs.deeptutor.info/get-started/pypi/)

---
**[THUKEG | 清华]{s}**
* **[THUKEG](https://github.com/THUDM)**
...
---
**[Mert Metin Tekdemir · website share]{s}**
* **[Mert Metin Tekdemir](https://x.com/mertmetindev)**
...
* **[Handre | Free market pamphleteer.  自由市场传单作家。](https://x.com/Handre)**
  ...
  [En: Rome handed out free grain to 40,000 citizens in 73 BC. By 46 BC, Julius Caesar found 320,000 people lining up for their monthly ration. That eight-fold expansion happened in under three decades, and it shows you how welfare states actually grow.]{s}
  [Cn: 罗马在公元前73年向4万名公民发放免费粮食。到公元前46年，朱利叶斯·凯撒发现有32万人排队领取每月配给。这种八倍的增长发生在不到三十年的时间里，这说明福利国家实际上是如何扩张的。]{g}

  [En: No Roman senator stood up and announced a plan to addict a third of the city to government bread. It happened incrementally, through political competition. Each magistrate who wanted votes expanded eligibility. Each expansion normalized the next one. The citizen who once considered the dole shameful eventually expected it, then demanded it, then organized politically to protect it.]{s}
  [Cn: 没有罗马元老院的议员站起来宣布一个计划，让城市中三分之一的人沉迷于政府发放的面包。这一切是逐步发生的，通过政治竞争。每一位想要获得选票的地方官都扩大了资格范围。每一次扩大都使下一次的扩大变得正常。曾经认为领取救济是耻辱的市民，最终开始期待它，然后要求它，最后组织政治力量来保护它。]{g}

  [En: This is the core mechanism free market thinkers have identified across every era: once you create a transfer program, you create a constituency for that program. Recipients vote. Administrators build careers. Grain merchants who supply the state develop a stake in keeping the contracts flowing. The political economy locks in.]{s}
  [Cn: 这是自由市场思想家在每个时代都识别出的核心机制：一旦你创建了一个转移计划，你就为这个计划建立了支持群体。接受者会投票。管理者则会建立职业发展路径。向国家提供粮食的商人会因合同的持续运转而产生利益关联。政治经济体系因此被锁定。]{g}

  [En: Caesar, to his credit, actually cut the rolls back to 150,000 through verification audits. It was one of his more economically coherent moves, though the Senate still murdered him. His successors quietly let the numbers climb again.]{s}
  [Cn: 凯撒值得称赞的是，他通过核实审计实际上将数量削减到了15万。这是他较为经济合理的举措之一，尽管参议院最终还是将他处死了。他的继任者们则悄悄地让数字再次上升。]{g}

  [En: What did the dole require? Massive grain imports from Sicily, Sardinia, and Egypt, organized through state logistics at state expense, funded by taxation and conquest. When the conquest revenue dried up, the obligation remained. Rome had written a check against future military success, and future military success eventually failed to arrive.]{s}
  [Cn: 失业救济需要什么？从西西里、撒丁尼亚和埃及大规模进口粮食，通过国家物流体系以国家开支来组织，资金来源于税收和征服。当征服所得减少时，这项义务依然存在。罗马在未来的军事胜利上签了一张支票，而未来的军事胜利最终未能兑现。]{g}
