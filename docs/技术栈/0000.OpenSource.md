...
* **[TED](https://www.ted.com/)**
  ...
  - [How the fridge changed food](https://www.ted.com/talks/nicola_twilley_how_the_fridge_changed_food)
...
* **[MoonTV·视频聚合播放器](https://github.com/catme1987/MoonTV)**
* **[花间集-历代古典诗词全集](https://gushici.dicomp.net/)**
* **[DICOMP数智胜任力 - 多场景效率搭子](https://dicomp.net/)**
...
---
**[Mirror]{s}**
* **[mirrorz | Mirror](https://github.com/mirrorz-org/mirrorz)**
...
* **[free.xn | free中国 | 各大官网集合](https://free.xn--fiqs8s/)**
  - [NewsNow](https://newsnow.busiyi.world/)
    * [pascalorg](https://github.com/pascalorg/editor)
      - [editor.pascal.app](https://editor.pascal.app/)

---
**[wxyShine | 王旭阳]{s}**
* **[wxyShine | 王旭阳](https://github.com/wxyShine)**
  - [Blog](https://www.wxy97.com/)
  - [Java知识库网站收集整理 - 王旭阳个人博客](https://www.wxy97.com/archives/0248581d-12c6-4468-a04f-c8824faa7118)

---
**[字节IDE]{s}**
* **[字节IDE | TRAE - The Real AI Engineer | TRAE - The Real AI Engineer](https://www.trae.cn/)**
...
---
**[DK English For EVERYONE]{s}**
  - [DK English](https://www.dkefe.com/cn)

---
**[翻译软件 | 字幕提取 | translation software]{s}**
  - **Transcribe | 原语言输出**
  - **Translate | 强制翻译成英文**
...
---
**[Way To AGI·AI unproxy]{s}**
* **[Way To AGI | AI unproxy](https://waytoagi.com)**
...
---
**[happyoyster·Ai]{s}**
* **[happyoyster | 世界就是你的牡蛎 | 世界任你探索、机会无限](https://www.happyoyster.com/home)**
...
---
**[LLM Bento]{s}**
* **[LLM Bento·大型语言模型（LLM）资料导航和学习网站](https://www.llm-bento.com/)**
...
---
**[thebuggeddev/anatomy]{s}**
* **[thebuggeddev](https://github.com/thebuggeddev/anatomy)**
  - [anatomy-livid.vercel.app](https://anatomy-livid.vercel.app/)

---
**[AI Reading Hub]{s}**
* **[All in AI，看见未来 | 每天精选最值得读的 AI 文章，帮你筛掉时代的噪音。](https://www.aireadinghub.com/)**
...
---
**[EasyChat-Claude官网镜像]{g}**
* **[EasyChat-Claude官网镜像](https://easychat.top/)**

---
**[neurapress]{g}**
* **[neurapress](https://github.com/tianyaxiang/neurapress)**
  - [md.newkit.site](https://md.newkit.site/)

---
**[ghiblio]{g}**
* **[ghiblio | PixToArt - 免费AI艺术生成器 | 创作AI图片和视频](https://ghiblio.art/zh)**
...
---
**[system-prompts-and-models-of-ai-tools]{g}**
* [system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools)

---
**[AI 3D 模型生成器：用文本和图片创建 3D | Meshy]{g}**
* **[Meshy·清华大学 | 3D建模](https://www.meshy.ai/)-**
...
* **[google-gemini/cookbook | Google Gemini](https://github.com/google-gemini/cookbook)**
  ...
  - [Google Gemini需要提供的key]{lb}

---
**[AlgerMusicPlayer | Music | Collect]{g}**
...
---
**[Free Ebook Foundation | 免费电子书籍集合]{g}**
...
* **[CodeBuddy | Tencent](https://www.codebuddy.ai/)**
  - [Tencent Cloud CodeBuddy is a next-generation AI Code Editor.]{g}
  - [腾讯云CodeBuddy是一款下一代AI代码编辑器。]{g}

  ---
  - [Powered by the Tencent Yuanbao Code Large Model, it provides services such as code completion, error diagnosis, technical Q&A, and performance optimization.]{g}
  - [它由腾讯元宝代码大型模型驱动，提供代码完成、错误诊断、技术问答和性能优化等服务。]{g}

  ---
  - [Supporting mainstream programming languages, it improves coding efficiency by 90% and reduces code error rates by 35%, making it suitable for enterprise-level application development and teaching practices.]{g}
  - [支持主流编程语言，编码效率提升90%，代码错误率降低35%，适合企业级应用开发和教学实践。]{g}
...
---
### 0016. freeCodeCamp | 免费的编程学习平台
**[freeCodeCamp]{g}**
* **[freeCodeCamp | 免费的编程学习平台](https://github.com/freeCodeCamp/freeCodeCamp)**
  - [freecodecamp](https://www.freecodecamp.org/)
  - [Contribute to freeCodeCamp intro](https://contribute.freecodecamp.org/intro/)
...
---
### 0019. 一个数据分析流程的"共享平台 + 模板库 + 协作中心"
* **[KNIME](https://www.knime.com/)**

---
### 0020. Ai website
* **[rhtv](https://www.rhtv.ai)**

---
### 0100. X.COM | 技术栈
**[liuliu-ai]{e}**
* **[六六AI研究所](https://liuliu-ai-research.pages.dev/)**

---
### 0101. Masteryeeeee | Game
**[MasterYeeeee]{s}**
* **[MasterYeeeee | 写代码的，画画的 | 贰佰章 | Douyin](https://v.douyin.com/2ZacFsS_O7A/)**
...
---
**[Lively-wallpaper]{s}**
* **[Lively-wallpaper](https://github.com/Lively-wallpaper/lively)**

---
**[rocksdanister]{s}**
* **[rocksdanister](https://github.com/rocksdanister/lively)**
